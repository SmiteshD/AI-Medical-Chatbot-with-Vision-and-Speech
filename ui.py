...
from bot_voice import text_to_speech_with_gtts, text_to_speech_with_elevenlabs
...
def process_inputs(audio_filepath, image_filepath):
    ...
    if image_filepath:
        ...
        doctor_response = "Please provide the image for me to analyze"
...
iface = gr.Interface(
    ...
    title="AI Medical Chatbot with Vision and Speech"
)
